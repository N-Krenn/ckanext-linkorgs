...
Document any optional config settings here. For example::
    ...
    # (optional, default: 24).
    ckanext.linkorgs.some_setting = some_default_value
...
To install ckanext-linkorgs for development, activate your CKAN virtualenv and
do::

    git clone https://github.com/N-Krenn/ckanext-linkorgs.git
    cd ckanext-linkorgs
...
coverage installed in your virtualenv (``pip install coverage``) then run::
    ...
    nosetests --nologcapture --with-pylons=test.ini --with-coverage --cover-package=ckanext.linkorgs --cover-inclusive --cover-erase --cover-tests


---------------------------------
Registering ckanext-linkorgs on PyPI
---------------------------------

ckanext-linkorgs should be availabe on PyPI as
https://pypi.python.org/pypi/ckanext-linkorgs. If that link doesn't work, then
...
----------------------------------------
Releasing a New Version of ckanext-linkorgs
----------------------------------------

ckanext-linkorgs is availabe on PyPI as https://pypi.python.org/pypi/ckanext-linkorgs.
